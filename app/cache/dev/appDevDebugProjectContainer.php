...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_45483329dcaed5dda418484097eedae34c3f94fdcd1bfea086505976e98385d5');
    ...
    protected function getSecurity_Firewall_Map_Context_RestService()
    {
        ...
        return $this->services['security.firewall.map.context.rest'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $a, 'rest', array(0 => $b), $c), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '65131737b49969.03066265', $c, $a), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'rest', $b, NULL, NULL, $c, true), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'console.command.ids' => array(
                ...
                33 => 'sensio_distribution.security_checker.command',
            ),
        );
    }
}
