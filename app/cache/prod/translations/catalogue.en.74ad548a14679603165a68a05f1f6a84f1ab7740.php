...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'password.require_special' => 'Your password must include at least one special character.',
    'password.require_lower_upper' => 'Your password must include one lower and upper case letter.',
    'password.require_number' => 'Your password must include at least one number.',
    'password.require_lower' => 'Your password must include one lower case letter.',
    'password.require_upper' => 'Your password must include one upper case letter.',
    'password.require_casediff' => 'Your password must include both upper and lower case letters.',
    'password.minlength' => 'Your password must be at least {{length}} characters long.',
    'username.alphanumeric' => 'The string "{{ string }}" contains an illegal character: it can only contain letters or dash (_).',
    'pass.id_pin_not_found' => 'The ID + Pin couple does not exist in our database or is not active or has already been used',
  ),
  'security' => 
  array (
...
',
  ...
  array (
    ...
    'No data' => 'No data',
    'No result' => 'No result',
    'Selected _s_ rows' => 'Selected _s_ rows',
    'Actions' => 'Actions',
    'home.title' => 'Welcome to official website of PASS SANTE',
    'home.button.submit' => 'Submit',
    'home.banner.title0' => 'Pass<span class="fa fa-plus-square text-primary"></span>Sante',
    'home.menu.title1' => 'Your e-sante solution',
    'home.menu.home' => 'Home',
    'home.menu.pass' => 'Pass Sante',
    'home.menu.partners' => 'Partners',
    'home.menu.contact' => 'Contact us',
    'home.menu.login' => 'Login',
    'home.menu.account' => 'My Account',
    'home.menu.register' => 'Register',
    'home.menu.surveillance' => 'Monitoring',
    'home.menu.sensibilisation' => 'Awareness',
    'home.menu.login_register' => 'Login/Register',
    'home.menu.pharmacie' => 'E-Pharmacy',
    'home.menu.distrib' => 'Distribution Network',
    'home.menu.franchise' => 'Franchises',
    'home.menu.presentation' => 'Presentation',
    'home.menu.hiw' => 'How it works ?',
    'home.menu.pharmacie_garde' => 'All-night drugstore',
    'home.menu.download_app' => 'PASS SANTE app',
    'home.footer.footer1.title' => '#PASS SANTE',
    'home.footer.footer1.menu.register' => 'Register',
    'home.footer.footer2.title' => 'Health centres',
    'home.footer.footer3.title' => 'Download our app',
    'home.footer.copyright' => 'Built with <span class="fa fa-heart color-primary"></span>  by <a href="//mcm-ci.com"><strong><abbr title="Maurice Communication marketing">MCM</abbr></strong></a>',
    'home.btn.submit' => 'Submit',
    'home.btn.send' => 'Send',
    'home.btn.logout' => 'Logout',
    'home.form.id' => 'Enter your ID',
    'home.form.pin' => 'Enter your PIN',
    'home.form.lang.chose_lang' => 'Chose a language',
    'home.form.lang.fr' => 'French',
    'home.form.lang.en' => 'English',
    'home.form.contact.contact' => 'Phone Number',
    'home.form.contact.name' => 'Name',
    'home.form.contact.email' => 'Email',
    'home.form.contact.subject' => 'Object',
    'home.form.contact.message' => 'Message',
    'home.form.contact.categorie' => 'Category',
    'home.form.contact.dropdown_categories.technical' => 'Technical problems',
    'home.form.contact.dropdown_categories.info' => 'Informations',
    'home.form.contact.dropdown_categories.convention' => 'Convention application (Health Centres, Schools, Pharmacies, Insurance)',
    'home.form.contact.dropdown_categories.franchise' => 'Franchise application',
    'home.form.contact.dropdown_categories.other' => 'Other',
    'home.form.contact.form_message.success' => 'Your email has been successfully sent',
    'home.form.contact.form_message.error' => 'Error while sending email, please retry',
    'home.section.award.title' => 'Awards',
    'home.section.vip.title' => 'THEY ARE WITH US',
    'home.section.distrib.title' => 'Distribution <b>Network</b>',
    'home.section.distrib.content1' => 'PASS SANTE is available at MCM\'s head office in Marcory Sainte-Thérèse. You can contact us at +22508289006 for more info.
',
    'home.section.distrib.content2' => 'It is also available in our pharmacies, partner health centers and franchises.
',
    'home.section.pass.title' => 'Get The PASS',
    'home.section.pass.content0' => '
',
    'home.section.pass.Individuals or professionals, get your PASS by contacting us' => 'Individuals or professionals, get your PASS by contacting us at the  <a href="tel:+22508289006" class="color-white">+22508289006</a>/<a href="tel:+22554631663" class="color-white">+22554631663</a> or writing us at  <a href="mailto:dg@mcm-ci.com" class="color-white">dg@mcm-ci.com</a>',
    'home.section.pass.content1' => 'You can use our contact form for more informations',
    'home.section.contact.title' => 'Contact <b>us</b>',
    'home.section.profile.title' => 'Your profile',
    'home.section.profile.intro' => 'Please return your bracket or use your card (eventually)',
    'home.section.partners.title' => 'Our <b>partners</b>',
    'home.section.temoignage.title' => 'Testimonies',
    'home.section.temoignage.temoignage1.content' => 'PASS SANTE is an innovative solution more than a TIC solution is a real response to the problem of desert medical... It of fast, reliable and convenient
',
    'home.section.temoignage.temoignage1.author' => 'Anicet M. Dally (Social Media Manager)',
    'home.section.temoignage.temoignage2.content' => 'With PASS SANTE, I have insurance to be supported in an emergency. And especially for my children, I am more reassured when I know that they will be supported because the Pass speaks for them.
',
    'home.section.temoignage.temoignage2.author' => 'Bogba Degne Mireille (Management Assistant)',
    'home.section.temoignage.temoignage3.content' => 'It is a jewel that is the electronic health record for anyone downwind in which one can have all the medical information; blood, and other critical information for its efficient management and effective group.
',
    'home.section.temoignage.temoignage3.author' => 'Gnanhi Zakpa Richmond (Radiotherapist )',
    'home.section.temoignage.temoignage4.content' => 'Beyond the technical Aspect, is the dimension of awareness and transformation of the approach of the other vision of health in Africa that has me impressed.  Indeed, in addition to being a functional tool, which enhances the ability to support patients, Pass Santé Mousso, implies a coordination of different public and private service for its optimal use.
',
    'home.section.temoignage.temoignage4.author' => 'Mbépongo Dédy Bilamba (marketing and communication consultant, Marketing Director of the Africa Festival 2016 Web )
',
    'home.section.presentation.part_video' => 'Press the button to play the video',
    'home.section.presentation.section0.title' => 'Presentation',
    'home.section.presentation.section0.content' => '<strong>PASS SANTE MOUSSO</strong> is a jewel (bracelet, medallion) and/or a connected card associated with an online platform. It allows its owner to take his personal and medical data with him everywhere and make it available, if necessary, to medical and emergency personnel. It is digital personalized medical record, a tool for response to emergency care.
',
    'home.section.presentation.section1.title' => 'Why ?',
    'home.section.presentation.section1.content' => '<ul>
  ...
  <li>The difficulty of taking care of people who arrive at the unconscious emergencies. The lack of medical information can be a factor in poor quality management and a source of medical errors..</li>
    ...
    'home.section.presentation.section2.title' => 'Features',
    'home.section.presentation.section2.content' => '<ul>
  ...
  <li>Follow-up consultation with your loved ones by associated accounts</li>
    ...
    'home.section.presentation.section3.title' => 'Advantages',
    'home.section.presentation.section3.content' => '<p>It improves the care of patients, reduces the risk of medical errors due to lack of patient information and above all allows for continuous and quality medical supervision</p>',
    'home.section.presentation.section4.title' => 'Target',
    'home.section.presentation.section4.n_content' => '<ul class="list-target">
  <li>
...
',
    'home.section.presentation.section4.content.content0.title' => 'Man, woman, children',
    'home.section.presentation.section4.content.content0.label' => 'It serves as a health book. It carries the information for support.',
    'home.section.presentation.section4.content.content1.title' => 'Health centres',
    'home.section.presentation.section4.content.content1.label' => 'It gives access to medical history for a better support and avoids medical errors.',
    'home.section.presentation.section4.content.content2.title' => 'Enterprise',
    'home.section.presentation.section4.content.content2.label' => 'Employees have insurance to be supported at all times especially those construction, electricity etc.',
    'home.section.presentation.section4.content.content3.title' => 'School',
    'home.section.presentation.section4.content.content3.label' => 'Informs about the State of health of our children and students, and reassures the parent',
    'home.section.presentation.section4.content.content4.title' => 'Insurance',
    'home.section.presentation.section4.content.content4.label' => 'Offers innovative services (availability of data) to improve the State of health and follow-up of participants',
    'home.section.presentation.section4.content.content5.title' => 'Pharmacy',
    'home.section.presentation.section4.content.content5.label' => 'Access to medical prescriptions and medical history of the patients',
    'home.section.innovation.titl0' => 'PASS SANTE MOUSSO',
    'home.section.innovation.title' => 'Medical innovation',
    'home.section.innovation.section0.virsion' => 'Our objective is to provide the populations with a solution which improves their medical care.
',
    'home.section.innovation.section0.pdg' => 'Director General of MCM',
    'home.section.innovation.section0.titl0' => 'Patients',
    'home.section.innovation.section0.content0' => 'Important event management system SMS notification.',
    'home.section.innovation.section0.content1' => 'Improve adherence and therapeutic education.',
    'home.section.innovation.section0.content2' => 'Health book',
    'home.section.innovation.section0.content3' => 'Connected objects (Jewelry)',
    'home.section.innovation.section0.title1' => 'HEALTH PROFESSIONALS',
    'home.section.innovation.section0.content4' => 'Patient record management system.',
    'home.section.innovation.section0.content5' => 'Patient monitoring tools',
    'home.section.innovation.section0.content6' => 'Time saving and efficiency.',
    'home.section.innovation.technique.h1' => 'Technical service, always attentive to your needs 24 hours a day!',
    'home.section.innovation.technique.label' => 'to answer you as quickly as possible.',
    'home.section.innovation.first_circle.title' => 'Data security and anonymization',
    'home.section.innovation.first_circle.content.ligne1' => 'Medical data secured thanks to my ID, my unique PIN and my MARTICULE.',
    'home.section.innovation.first_circle.content.ligne2' => 'Data anonymization \':\' We anonymize all your information.',
    'home.section.innovation.first_circle.content.ligne3' => 'Secure medical history.',
    'home.section.innovation.first_circle.content.ligne4' => 'Data anonymization \':\' Patient consultation notifications.',
    'home.section.innovation.second_circle.title' => 'Improvement of medical care',
    'home.section.innovation.second_circle.content.ligne1' => 'Communication between patient and healthcare professionals.',
    'home.section.innovation.second_circle.content.ligne2' => 'Facilitates remote care of Patients.',
    'home.section.innovation.second_circle.content.ligne3' => 'Allow to stay in contact with the doctor and to make an online consultation.',
    'home.section.innovation.second_circle.content.ligne4' => 'Avoid repeated examinations.',
    'home.section.innovation.second_circle.content.ligne5' => 'Allows patients and healthcare professionals to optimize their medical care.',
    'home.section.innovation.second_circle.content.ligne6' => 'Remote monitoring of patients.',
    'home.section.innovation.third_circle.title1' => 'Associated account',
    'home.section.innovation.third_circle.content.ligne1' => 'Attach the child\'s file to its mother; like a mother-child notebook to help reduce maternal and infant mortality.',
    'home.section.innovation.third_circle.title2' => '24/7 Discussion with the entire care team',
    'home.section.parteners.label' => '<span> OUR </span> PARTNERS',
    'home.section.parteners.titl0' => 'FOR THE PASS SANTE',
    'home.section.parteners.title' => 'They trust us',
    'api.profil_not_found' => 'Profile not found',
    ...
    'sensibilisation.section0.title1' => 'Prevention measure',
    'sensibilisation.section0.content' => 'Coronavirus disease 2019 (COVID-19) is an infectious ‎ due to a recently discovered coronavirus ‎.  ‎The majority of people with COVID-19 ‎ will experience only mild or ‎ mild symptoms and will recover without special treatment.
',
    'sensibilisation.section1.title1' => 'AWARENESS',
    'sensibilisation.language.title' => 'LOCAL LANGUAGE',
    'sensibilisation.language.section1.country' => 'Senegal',
    'sensibilisation.actions.section1.title' => 'Often wash your hands.',
    'sensibilisation.actions.section1.content' => 'Use soap and  water, or a hydroalcoholic solution',
    'sensibilisation.actions.section2.title' => 'Maintain social distance.',
    'sensibilisation.actions.section2.content' => 'Stay away from anyone who coughs  or sneezes.',
    'sensibilisation.actions.section3.title' => 'Avoid touching your face.',
    'sensibilisation.actions.section3.content' => 'Do not touch his eyes, nose or mouth.',
    'sensibilisation.actions.section4.title' => 'Use a mask.',
    'sensibilisation.actions.section4.content' => 'In case of cough or sneezing, cover  mouth and nose with the bend of the elbow or with a  handkerchief.',
    'sensibilisation.actions.section5.title' => 'Ask for medical care.',
    'sensibilisation.actions.section5.content' => 'If you are not feeling well, stay home if you are in doubt, consult a doctor',
    'sensibilisation.actions.section6.title' => 'Stay informed',
    'sensibilisation.actions.section6.content' => 'Keep up-to-date to find out where the virus spreads on a large scale.',
  ),
  'KnpPaginatorBundle' => 
  array (
