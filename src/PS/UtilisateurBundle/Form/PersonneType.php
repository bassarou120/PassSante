...
class PersonneType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('nom', null, ['label' => 'personne.form.nom'])
           ...
           ->add('photo', ImageType::class, ['label' => false, 'required' => false])
            ...
            ->add('hopital', EntityType::class, [
                'class' => Hopital::class, 
                'choice_label' => 'nom',
                'label' => 'Hopital de soins' ,
                'required' => false, 
                'placeholder' => 'Hopital de soins',
                'attr'  => [
                    'class' => 'select2 select2-corporate',
                ],
                // 'expanded' => false,
        ...
        if ($dateFormat == 'api') {
            $props = ['datenaissance', DateTimeType::class, ['widget' => 'single_text']];
        } else {
            $props = ['datenaissance', BirthdayType::class, [
                'widget' => 'single_text', 'format' => 'dd/mm/yyyy', 'label' => 'personne.form.datenaissance', 'required' => true, 'invalid_message' => 'Date de naissance invalide. Format attendu (01/01/1900)'
            ]];
        }
