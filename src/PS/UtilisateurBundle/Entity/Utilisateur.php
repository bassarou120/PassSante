...
class Utilisateur extends BaseUser implements EquatableInterface, EncoderAwareInterface
{
    ...
    , filter="select"
    , selectFrom="values"
    , values={"ROLE_SUPER_ADMIN":"Super Administrateur", "ROLE_ADMIN": "Administrateur", "ROLE_CUSTOMER":"Patient", "ROLE_MEDECIN": "Medecin", "ROLE_INFIRMIER": "Infirmier", "ROLE_PHARMACIE": "Pharmacien", "ROLE_RECEPTION": "Réceptionniste", "ROLE_ADMIN_LOCAL": "Admin Local", "ROLE_ADMIN_CORPORATE": "Admin Du groupe médical", "ROLE_ADMIN_SUP": "Admin Suppléant"}
    )
     * @Groups({"user"})
     * @Expose
     */
