...
class Personne
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="\PS\GestionBundle\Entity\Patient", mappedBy="personne", cascade={"persist", "remove"})
     * @Groups({"associe"})
     */
    private $patient;
    ...
    public function __construct()
    {
        ...
        $this->hopital = new ArrayCollection();
    }
    ...
    public function getHopital()
    {
        ...
        $hopital = [];
        if (is_iterable($this->personneHopital)) {
    ...
    // public function addPatientAssurance(PatientAssurance $patientAssurance): self
    // {
    //     if (!$this->patientAssurances->contains($patientAssurance)) {
    //         $this->patientAssurances[] = $patientAssurance;
    //         $patientAssurance->setAssurance($this);
    //     }
