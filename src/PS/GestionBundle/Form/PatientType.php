...
use PS\GestionBundle\Form\FichePatientCancerType;
...
class PatientType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('personne', PersonneType::class, ['label' => false, 'date_format' => $options['date_format']])
            ->add('fichePatientCancer', FichePatientCancerType::class, [
                'label' => false,
                'required' => false,
