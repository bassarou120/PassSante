...
class Medecin
{
    ...
    private $consultations;
     ...
     /**
     * @ORM\OneToMany(targetEntity="ConsultationCancer", mappedBy="medecin")
     */
    private $consultationsCancers;
    ...
    public function __construct()
    {
        ...
        $this->consultationsCancers = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * @return Medecin
     */
    public function addConsultationCancer(\PS\GestionBundle\Entity\ConsultationCancer $consultationsCancer)
    {
        $this->consultationsCancers[] = $consultationsCancer;
     ...
     */
    public function removeConsultationCancer(\PS\GestionBundle\Entity\ConsultationCancer $consultationsCancer)
    {
        $this->consultationsCancers->removeElement($consultationsCancer);
    }
    ...
    {
        return $this->consultationsCancers;
    }
