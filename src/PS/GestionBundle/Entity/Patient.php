 ...
 * @GRID\Source(columns="id,matricule,personne.dateInscription,personne.nom,personne.prenom,nom_complet,personne.contact,personne.corporate.raisonSociale,identifiant,profession,societe,sexe,personne.datenaissance")
...
class Patient
{
     ...
     * @GRID\Column(title="patient.form.matricule")
     * @Groups({"patient"})
     */
    private $matricule;
    ...
    /**
     * @ORM\OneToMany(targetEntity="ConsultationCancer", mappedBy="patient", cascade={"persist", "remove"})
     * @Groups({"patient"})
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="\PS\GestionBundle\Entity\FichePatientCancer", mappedBy="patient",  cascade={"persist", "remove"})
     */
    ...
    /**
     * Add ConsultationCancer
     *
     * @param \PS\GestionBundle\Entity\ConsultationCancer $consultationCancer
     *
     * @return Patient
     */
    public function addConsultationCancers(\PS\GestionBundle\Entity\ConsultationCancer $consultationCancer) : self
    {
    ...
    /**
     * Remove ConsultationCancer
     *
     * @param \PS\UtilisateurBundle\Entity\ConsultationCancer $consultationCancer
     */
    public function removeConsultationCancers(\PS\GestionBundle\Entity\ConsultationCancer $consultationCancer) : self
    {
    ...
    /**
     * Get ConsultationCancer
     *
     * @return Collection<int, ConsultationCancer>
     */
    public function getConsultationCancers() : Collection
    {
    ...
    /**
     * Get the value of fichePatientCancer
     * @return \PS\GestionBundle\Entity\FichePatientCancer
     */
    public function getFichePatientCancer()
    {
        return $this->fichePatientCancer;
    }

    /**
     * Set the value of fichePatientCancer
     * @param \PS\GestionBundle\Entity\FichePatientCancer $fichePatientCancer
     * @return Patient
     */
    public function setFichePatientCancer(\PS\GestionBundle\Entity\FichePatientCancer $fichePatientCancer): self
    {
