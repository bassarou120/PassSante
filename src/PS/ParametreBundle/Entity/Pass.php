...
class Pass
{
     ...
     * @GRID\Column(title="pass.form.id", primary=true)
     */
    private $id;
     ...
     * @GRID\Column(title="pass.form.identifiant",  operators={"rlike"}, defaultOperator="rlike", filterable=true)
     */
    private $identifiant;
     ...
     * @GRID\Column(title="pass.form.pin", operators={"rlike"}, defaultOperator="rlike", filterable=true)
     */
    private $pin;
     ...
     * @GRID\Column(title="pass.form.actif", safe=false)
     */
    private $actif;
     ...
     * @GRID\Column(title="pass.form.dateCreation", operatorsVisible=false, filterable=true)
     */
