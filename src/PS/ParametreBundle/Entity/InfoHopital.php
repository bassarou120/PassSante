...
class InfoHopital
{
     ...
     * @var string
     * @Assert\NotNull(message="Veuillez renseigner les contacts de l'hôpital")
     * @ORM\Column(name="contactsPermanance", type="string", length=100)
     * @Groups({"info-hopital"})
     */
    private $contactsPermanance;
     ...
     * Set contacts
     *
     * @param string $contactsPermanance
     *
     * @return InfoHopital
     */
    public function setContactsPermanance($contactsPermanance)
    {
        $this->contactsPermanance = $contactsPermanance;

        return $this;
    }

    /**
     * Get contactsPermanance
     *
     * @return string
     */
    public function getContactsPermanance()
    {
        return $this->contactsPermanance;
    }
